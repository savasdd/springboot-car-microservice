...
public class KafkaConsumerConfig {
    ...
    private static final String GROUP_ID = "stock_kafka";
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> filterStringKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, String> factory = stringKafkaListenerContainerFactory(GROUP_ID);
        return factory;
    }
}